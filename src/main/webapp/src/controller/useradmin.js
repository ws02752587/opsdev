...
layui.define(['table', 'form'], function(exports){
  ...
  table.render({
    ...
    ,cols: [[
      ...
      ,{field: 'sex', width: 80, title: '性别' ,templet: '#tmplsex'}
      //,{field: 'ip', title: 'IP'}
    ...
    if(obj.event === 'del'){
      ...
      admin.popup({
        ...
        ,success: function(layero, index){
          view(this.id).render('user/webuser/userform', data).done(function(){
