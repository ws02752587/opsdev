...
layui.define(['table', 'form','laydate'], function(exports){
  ...
  table.render({
    elem: '#LAY-svn-manage'
    ,url: '/beonlineEdition/queryPage.do'
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
      ,{field: 'beonlineDate', title: '上线日期', minWidth: 100}
      ,{field: 'editionMark', width: 250, title: '版本类型' ,templet: '#tmpltype'}
    ...
    if(obj.event === 'del'){
      ...
      admin.popup({
        ...
        ,success: function(layero, index){
          view(this.id).render('edition/beonline/beonlineform', data).done(function(){
