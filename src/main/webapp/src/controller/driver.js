...
layui.define(['table', 'form','laydate'], function(exports){
  ...
  table.render({
    elem: '#LAY-svn-manage'
    ,url: '/editionVersion/queryPage.do'
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
      ,{field: 'editionId', width: 250, title: '版本类型' ,templet: '#tmpltype'}
      ,{field: 'version', title: '客户端版本号', minWidth: 100}
    ...
    if(obj.event === 'del'){
      ...
      admin.popup({
        ...
        ,success: function(layero, index){
          view(this.id).render('edition/driver/driverform', data).done(function(){
